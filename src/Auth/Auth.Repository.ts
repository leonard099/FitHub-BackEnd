...
export class AuthRepository {
    ...
    constructor(@InjectRepository(Users) private usersRepository:Repository<Users>, private readonly jwtService: JwtService) {}
    ...
    async signup(body: CreateUserDto): Promise<string> {
        const usuario = await this.usersRepository.findOne({where: {email: body.email}});
        if (usuario) {
